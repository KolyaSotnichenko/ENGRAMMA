...
- **Migration Tool for Competitor Import**
  ...
  - Reads backend configuration from root `.env` file (`ENGRAMMA_PORT`, `ENGRAMMA_API_KEY`)
...
- **HYBRID Tier Performance Mode**
  ...
  - Configurable via `ENGRAMMA_TIER=hybrid`, `ENGRAMMA_KEYWORD_BOOST`, `ENGRAMMA_KEYWORD_MIN_LENGTH`
